...
INSERT INTO `migrations` VALUES (107,'2014_10_12_000000_create_users_table',1),(108,'2014_10_12_100000_create_password_resets_table',1),(109,'2018_02_10_060001_create_vehicles_table',1),(110,'2018_02_10_060029_create_clients_table',1),(111,'2018_02_10_060038_create_items_table',1),(112,'2018_02_10_061201_create_commands_table',1),(113,'2018_02_10_061235_create_sessions_table',1),(114,'2018_02_10_061250_create_vehicle_items_table',1),(115,'2018_02_10_074038_create_command_items_table',1),(116,'2018_02_10_074050_create_session_commands_table',1),(117,'2018_02_10_074100_create_session_pos_table',1);
...
--
-- Table structure for table `session_commands`
--
...
CREATE TABLE `session_commands` (
  ...
  KEY `session_commands_commandid_foreign` (`commandId`),
  CONSTRAINT `session_commands_commandid_foreign` FOREIGN KEY (`commandId`) REFERENCES `commands` (`id`),
  CONSTRAINT `session_commands_sessionid_foreign` FOREIGN KEY (`sessionId`) REFERENCES `sessions` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `session_commands`
--

LOCK TABLES `session_commands` WRITE;
/*!40000 ALTER TABLE `session_commands` DISABLE KEYS */;
/*!40000 ALTER TABLE `session_commands` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-02-11 11:16:58
